        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Departments</span> <i
                            class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-department.php"><i class="fa fa-bars"></i> <span>Create
                                    Department</span></a>
                        </li>
                        <li><a href="manage-department.php"><i class="fa fa fa-server"></i> <span>Manage
                                    Departments</span></a>
                        </li>
            ...
            <li class="has-children">
                <a href="#"><i class="fa fa-info-circle"></i> <span>Attendance</span> <i
                        class="fa fa-angle-right arrow"></i></a>
                <ul class="child-nav">
                    <li><a href="add-attendance.php"><i class="fa fa-bars"></i> <span>Add Attendance</span></a></li>
                    <li><a href="manage-attendances.php"><i class="fa fa fa-server"></i> <span>Manage
                                Attendance</span></a>
                    </li>
