                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tbldepartments.DepartmentName,tblsubjects.SubjectName,tblresult.* FROM `tblresult`  
JOIN tblstudents 
	on tblstudents.StudentId = tblresult.StudentId
JOIN tbldepartments 
	on tbldepartments.id = tblresult.DepartmentId
JOIN tblsubjects
...
?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="edit-result.php?stid=<?php echo htmlentities($result->StudentId);?>">
