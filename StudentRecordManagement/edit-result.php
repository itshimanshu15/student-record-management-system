...
$ret = "SELECT tblstudents.StudentName,tbldepartments.DepartmentName,tbldepartments.Semester from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tbldepartments on tbldepartments.id=tblstudents.DepartmentId where tblstudents.StudentId=:stid limit 1";
