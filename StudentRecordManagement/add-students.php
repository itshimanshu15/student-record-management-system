...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,DOB,DepartmentId,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:dob,:departmentid,:status)";
