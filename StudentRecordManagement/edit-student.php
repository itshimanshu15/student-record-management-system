...
$sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tbldepartments.DepartmentName,tbldepartments.Semester from tblstudents join tbldepartments on tbldepartments.id=tblstudents.StudentId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="departmentname" class="form-control"
                                                        id="departmentname"
                                                        value="<?php echo htmlentities($result->DepartmentName)?>(<?php echo htmlentities($result->Semester)?>)"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
