...
$did=intval($_GET['departmentid']);
$sql="update  tbldepartments set DepartmentName=:departmentname,Semester=:semester where id=:did ";
...
{   ?>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <div class="">
                                                    ...
                                                    <span class="help-block">Eg- Computer (CE), Information Techno.
                                                        (IT),Chemical (ChE) etc</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                ...
                                                <div class="">
                                                    <input type="number" name="semester"
                                                        value="<?php echo htmlentities($result->Semester);?>"
                                                        required="required" class="form-control" id="success">
