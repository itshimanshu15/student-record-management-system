                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT tbldepartments.DepartmentName,tbldepartments.Semester,tblsubjects.SubjectName,tblsubjectcombination.id as scid,tblsubjectcombination.status from tblsubjectcombination join tbldepartments on tbldepartments.id=tblsubjectcombination.DepartmentId  join tblsubjects on tblsubjects.id=tblsubjectcombination.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
...
{   ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($result->DepartmentName);?> &nbsp;
                                                            Semester-<?php echo htmlentities($result->Semester);?></td>
...
{ ?>
                                                            <a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>"
                                                                onclick="confirm('do you really want to ativate this subject');"><i
                                                                    class="fa fa-times" title="Acticvate Record"></i>
                                                            </a><?php } else {?>
                                                            ...
                                                            <a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>"
                                                                onclick="confirm('do you really want to deativate this subject');"><i
                                                                    class="fa fa-check" title="Deactivate Record"></i>
                                                            </a>
                                                            <?php }?>
                                                        </td>
                                                    </tr>
